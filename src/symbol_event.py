...
class SymbolEvent:
    ...
    def __init__(self, symbol: str, event_dates: list[date], pre_event: int, post_event: int, max_offset: int, benchmark_symbol: str) -> None:
        ...
        assert post_event >= 0
        assert max_offset >= 0
        assert benchmark_symbol != symbol
